...
class ResNet(nn.Module):
    ...
    def __init__(self, conv, block, n, num_classes=4, s=1):
...
def resnet34(pretrained=False, conv=Conv, block=OldBlock, num_classes=6):
    """Constructs a ResNet-34 model.
    Args:
        pretrained (bool): If True, returns a model pre-trained on ImageNet
    """
    model = ResNet(conv,block, [3, 4, 6, 3],num_classes=num_classes)
